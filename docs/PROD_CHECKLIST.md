...
- [x] Документация по UDP‑балансировке RADIUS в проде.
- [x] Дашборд/витрина мониторинга RADIUS.
- [x] Тестирование восстановления RADIUS/VPN после сбоя.
...
- [x] Дашборд аудита VPN‑сессий/подключений.
